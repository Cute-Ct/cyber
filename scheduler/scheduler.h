...
#include "proto/choreography_conf.pb.h"
...
using cyber::base::AtomicHashMap;
using cyber::base::AtomicRWLock;
using cyber::base::ReadLockGuard;
using cyber::croutine::CRoutine;
using cyber::croutine::RoutineFactory;
using cyber::data::DataVisitorBase;
using cyber::proto::InnerThread;

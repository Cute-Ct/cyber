...
#include "scheduler/policy/scheduler_choreography.h"
...
#include "scheduler/policy/choreography_context.h"
...
using cyber::base::AtomicRWLock;
using cyber::base::ReadLockGuard;
using cyber::base::WriteLockGuard;
using cyber::common::GetAbsolutePath;
using cyber::common::GetProtoFromFile;
using cyber::common::GlobalData;
using cyber::common::PathExists;
using cyber::common::WorkRoot;
using cyber::croutine::RoutineState;
...
SchedulerChoreography::SchedulerChoreography()
  ...
  if (PathExists(cfg_file) && GetProtoFromFile(cfg_file, &cfg)) {
    ...
    const cyber::proto::ChoreographyConf& choreography_conf =

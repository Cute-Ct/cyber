...
using GlobalData = ::cyber::common::GlobalData;

using AtomicRWLock = ::cyber::base::AtomicRWLock;
using AtomicWriteLockGuard =
    ::cyber::base::WriteLockGuard<AtomicRWLock>;
using AtomicReadLockGuard = ::cyber::base::ReadLockGuard<AtomicRWLock>;
  ...
  switch (clock->mode_) {
    ...
    default:
      AFATAL << "Unsupported clock mode: "
             << cyber::common::ToInt(clock->mode_);
  }
  return Time::Now();
}

...
#include "class_loader/test/base.h"
#include "cyber.h"
...
using cyber::class_loader::ClassLoader;
using cyber::class_loader::ClassLoaderManager;
using cyber::class_loader::utility::IsLibraryLoadedByAnybody;
...
TEST(ClassLoaderTest, util_test) {
  ClassLoader loader1(LIBRARY_1);
  cyber::class_loader::utility::LoadLibrary("1", &loader1);
  cyber::class_loader::utility::UnloadLibrary("1", nullptr);
  cyber::class_loader::utility::IsLibraryLoaded(LIBRARY_1, &loader1);
  cyber::class_loader::utility::IsLibraryLoaded(LIBRARY_2, &loader1);
}

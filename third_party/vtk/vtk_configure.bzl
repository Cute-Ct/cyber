load("//build:common.bzl", "basename", "dirname")
load("//build/platform:common.bzl", "execute", "make_copy_dir_rule", "make_copy_files_rule")
...
def _vtk_match_version(repository_ctx, sysroot_dir = None):
    ...
    for prefix in reversed(prefix_dirs):
        ...
        for k in libdict:
            ...
            if lib_version == version and lib_prefix == prefix:

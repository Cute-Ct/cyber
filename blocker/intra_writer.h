...
class IntraWriter : public cyber::Writer<MessageT> {
 public:
  using MessagePtr = std::shared_ptr<MessageT>;
  using BlockerManagerPtr = std::shared_ptr<BlockerManager>;

  explicit IntraWriter(const cyber::proto::RoleAttributes& attr);
  virtual ~IntraWriter();
...
template <typename MessageT>
IntraWriter<MessageT>::IntraWriter(const cyber::proto::RoleAttributes& attr)

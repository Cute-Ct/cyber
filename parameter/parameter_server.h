...
class ParameterServer {
 public:
  using Param = cyber::proto::Param;
  using NodeName = cyber::proto::NodeName;
  using ParamName = cyber::proto::ParamName;
  using BoolResult = cyber::proto::BoolResult;
  using Params = cyber::proto::Params;
  /**

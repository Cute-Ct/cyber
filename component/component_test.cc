...
using cyber::proto::ComponentConfig;
using cyber::proto::TimerComponentConfig;
...
TEST(CommonComponent, init) {
  ret_proc = true;
  ret_init = true;
  cyber::proto::ComponentConfig compcfg;
  ...
  cyber::proto::ReaderOption *read_opt = compcfg.add_readers();
  ...
  cyber::proto::ReaderOption *read_opt2 = compcfg.add_readers();
  ...
  cyber::proto::ReaderOption *read_opt3 = compcfg.add_readers();
  read_opt3->set_channel("/driver/channel2");
  compcfg.set_name("perception4");
  cyber::proto::ReaderOption *read_opt4 = compcfg.add_readers();

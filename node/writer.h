...
class Writer : public WriterBase {
 public:
   ...
   */
  explicit Writer(const cyber::proto::RoleAttributes& role_attr);
  virtual ~Writer();
   ...
   */
  void GetReaders(std::vector<cyber::proto::RoleAttributes>* readers) override;
...
template <typename MessageT>
Writer<MessageT>::Writer(const cyber::proto::RoleAttributes& role_attr)
...
void Writer<MessageT>::JoinTheTopology() {
  ...
  std::vector<cyber::proto::RoleAttributes> readers;
...
template <typename MessageT>
void Writer<MessageT>::GetReaders(std::vector<cyber::proto::RoleAttributes>* readers) {
  if (readers == nullptr) {
    return;
  }

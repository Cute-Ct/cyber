...
using cyber::event::PerfEventCache;
using cyber::event::TransPerf;

/**
 * @class ReaderBase
 * @brief Base Class for Reader
 * Reader is identified by one cyber::proto::RoleAttribute,
...
class ReaderBase {
 public:
  explicit ReaderBase(const cyber::proto::RoleAttributes& role_attr)
   ...
   */
  virtual void GetWriters(std::vector<cyber::proto::RoleAttributes>* writers) {}
 ...
 protected:
  cyber::proto::RoleAttributes role_attr_;
...
class ReceiverManager {
 public:
   ...
   */
  auto GetReceiver(const cyber::proto::RoleAttributes& role_attr) ->
    ...
    receiver_map_[channel_name] =
        transport::Transport::Instance()->CreateReceiver<MessageT>(
            role_attr, [](const std::shared_ptr<MessageT>& msg,
                          ...
                          const cyber::proto::RoleAttributes& reader_attr) {
              (void)msg_info;
              (void)reader_attr;

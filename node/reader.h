...
class Reader : public ReaderBase {
 public:
   ...
   * pending_queue_size
   */
  explicit Reader(const cyber::proto::RoleAttributes& role_attr,
   ...
   */
  void GetWriters(std::vector<cyber::proto::RoleAttributes>* writers) override;
...
template <typename MessageT>
Reader<MessageT>::Reader(const cyber::proto::RoleAttributes& role_attr,
...
void Reader<MessageT>::JoinTheTopology() {
  ...
  std::vector<cyber::proto::RoleAttributes> writers;
...
template <typename MessageT>
void Reader<MessageT>::GetWriters(std::vector<cyber::proto::RoleAttributes>* writers) {
  if (writers == nullptr) {
    return;
  }

...
#include "node/node_service_impl.h"
...
template <typename MessageT>
auto Node::CreateWriter(const cyber::proto::RoleAttributes& role_attr)
    -> std::shared_ptr<Writer<MessageT>> {
...
template <typename MessageT>
auto Node::CreateReader(const cyber::proto::RoleAttributes& role_attr,

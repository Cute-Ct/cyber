...
using cyber::proto::Channel;
using cyber::proto::ChannelCache;
using cyber::proto::ChunkBody;
using cyber::proto::ChunkBodyCache;
using cyber::proto::ChunkHeader;
using cyber::proto::ChunkHeaderCache;
using cyber::proto::Header;
using cyber::proto::SectionType;
using cyber::proto::SingleIndex;
...
bool RecordFileWriter::Open(const std::string& path) {
  ...
  path_ = path;
  if (::cyber::common::PathExists(path_)) {

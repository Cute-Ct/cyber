...
#include "service_discovery/container/graph.h"
#include "service_discovery/container/multi_value_warehouse.h"
#include "service_discovery/container/single_value_warehouse.h"
#include "service_discovery/role/role.h"
#include "service_discovery/specific_manager/manager.h"
...
class ChannelManager : public Manager {
 ...
 public:
  using RoleAttrVec = std::vector<cyber::proto::RoleAttributes>;

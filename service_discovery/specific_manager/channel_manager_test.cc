...
#include "service_discovery/specific_manager/channel_manager.h"
...
#include "message/protobuf_factory.h"
#include "proto/unit_test.pb.h"
...
TEST_F(ChannelManagerTest, get_upstream_downstream) {
  std::vector<cyber::proto::RoleAttributes> nodes;
  for (int i = 0; i < channel_num_; ++i) {

...
#include "service_discovery/role/role.h"
...
class WarehouseBase {
 public:
  ...
  virtual void Remove(const cyber::proto::RoleAttributes& target_attr) = 0;
  ...
  virtual bool Search(uint64_t key,
                      cyber::proto::RoleAttributes* first_matched_role_attr) = 0;
  virtual bool Search(uint64_t key, std::vector<RolePtr>* matched_roles) = 0;
  virtual bool Search(
      uint64_t key, std::vector<cyber::proto::RoleAttributes>* matched_roles_attr) = 0;

  virtual bool Search(const cyber::proto::RoleAttributes& target_attr) = 0;
  virtual bool Search(const cyber::proto::RoleAttributes& target_attr,
  ...
  virtual bool Search(
      const cyber::proto::RoleAttributes& target_attr,
      std::vector<cyber::proto::RoleAttributes>* matched_roles_attr) = 0;

  virtual void GetAllRoles(std::vector<RolePtr>* roles) = 0;
  virtual void GetAllRoles(std::vector<cyber::proto::RoleAttributes>* roles_attr) = 0;
};
